...
public abstract class RecycleViewItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            RecyclerView.ViewHolder swpeViewHolder = recyclerView.findViewHolderForAdapterPosition(swipePosition);
            View swiperItem = swpeViewHolder.itemView;
            Rect rect = new Rect();
            swiperItem.getGlobalVisibleRect(rect);
    ...
    public RecycleViewItemTouchHelper(Context context, RecyclerView recyclerView, int buttonWidth) {
