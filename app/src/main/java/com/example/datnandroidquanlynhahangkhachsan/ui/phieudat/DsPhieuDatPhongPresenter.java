...
//
    ...
    @Override
    public void ThemPhieuDatPhong(DatPhongDTO datPhongDTO) {
        phieuDatModel.ThemPhieuDatPhong(datPhongDTO, new IPhieuDatModel.IOnThemPhieuDatPhongFinishedListener() {
            @Override
    ...
    @Override
    public void ThemPhieuDatBan(DatBanDTO datBanDTO) {
        phieuDatModel.ThemPhieuDatBan(datBanDTO, new IPhieuDatModel.IOnThemPhieuDatBanFinishedListener() {
            @Override
            public void onSuccess() {
                view.onThemPhieuDatBanSuccess();
            }
