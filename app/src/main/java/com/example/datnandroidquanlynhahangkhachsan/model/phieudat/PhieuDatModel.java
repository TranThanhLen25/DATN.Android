...
public class PhieuDatModel implements IPhieuDatModel {
    ...
    @Override
    public void LayDanhSachPhieuDat(int LoaiPhieu, IOnLayDanhSachPhieuDatFinishedListener listener) {
        ...
        service.getAccessToken(new IAPIServiceTokenRetrofit.IOnGetAccessTokenFinishedListener() {
            ...
            public void onSuccess(ResponseTokenDTO token) {
                ...
                service.apiServiceRetrofit.LayDanhSachPhieuDat(LoaiPhieu).enqueue(new Callback<ResponseDTO<List<PhieuDatDTO>>>() {
                    @Override
